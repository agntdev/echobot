# E2T1 — SQLite Database Setup

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 ECHO

Create the SQLite database file at /data/echoes.db with the counter table. Initialize the table with id=1 and total=0 on first run. Enable WAL mode for concurrency safety.
