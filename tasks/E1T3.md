...
Implement the /count command to return the global total of echoes served. Add the command to tests/commands.json and create a dialog spec in tests/specs/E1T3.json.
