# E1T2 — /echo <text> Command

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 ECHO

Implement the /echo <text> command to reply with the same text and increment the global counter. Add the command to tests/commands.json and create a dialog spec in tests/specs/E1T2.json.
