# E3T2 — Environment Configuration

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 ECHO

Configure the bot to read the TELEGRAM_TOKEN environment variable and handle fatal DB or API errors by exiting with a non-zero status code.
