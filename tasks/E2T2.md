# E2T2 — Atomic Counter Increment

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 ECHO

Implement an atomic increment operation for the global counter using an SQL UPDATE statement within a transaction. Ensure the increment is atomic to avoid lost increments.
